...
function nectar_custom_password_form() {
	...
	<p><label for="' . esc_attr($label) . '">' . __( 'Password:', 'default' ) . ' </label>  <input name="post_password" id="' . esc_attr($label) . '" type="password" size="20" /><input type="submit" name="Submit" value="' . esc_attr__( 'Submit', 'default' ) . '" /></p></form>';
	return $output;
