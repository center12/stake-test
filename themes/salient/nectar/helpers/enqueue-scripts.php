...
function nectar_register_js() {
	...
	if ( ! is_admin() ) {
		...
		// Third party scripts.
		wp_register_script( 'modernizer', $nectar_get_template_directory_uri . '/js/third-party/modernizr.js', 'jquery', '2.6.2', true );
		wp_register_script( 'imagesLoaded', $nectar_get_template_directory_uri . '/js/third-party/imagesLoaded.min.js', 'jquery', '4.1.4', true );
		wp_register_script( 'superfish', $nectar_get_template_directory_uri . '/js/third-party/superfish.js', 'jquery', '1.4.8', true );
		wp_register_script( 'hoverintent', $nectar_get_template_directory_uri . '/js/third-party/hoverintent.js', 'jquery', '1.9', true );
		wp_register_script( 'touchswipe', $nectar_get_template_directory_uri . '/js/third-party/touchswipe.min.js', 'jquery', '1.0', true );
		...
		wp_register_script( 'flickity', $nectar_get_template_directory_uri . '/js/third-party/flickity.min.js', 'jquery', '2.1.2', true );
		wp_register_script( 'magnific', $nectar_get_template_directory_uri . '/js/third-party/magnific.js', 'jquery', '7.0.1', true );
		wp_register_script( 'fancyBox', $nectar_get_template_directory_uri . '/js/third-party/jquery.fancybox.min.js', 'jquery', '7.0.1', true );
		wp_register_script( 'isotope', $nectar_get_template_directory_uri . '/js/third-party/isotope.min.js', 'jquery', '7.6', true );
		wp_register_script( 'select2', $nectar_get_template_directory_uri . '/js/third-party/select2.min.js', 'jquery', '3.5.2', true );
		wp_register_script( 'nectar-parallax', $nectar_get_template_directory_uri . '/js/third-party/parallax.js', 'jquery', '1.0', true );
		wp_register_script( 'nectar-transit', $nectar_get_template_directory_uri . '/js/third-party/transit.js', 'jquery', '0.9.9', true );
		wp_register_script( 'fullpage', $nectar_get_template_directory_uri . '/js/third-party/jquery.fullPage.min.js', 'jquery', $nectar_theme_version, true );
		wp_register_script( 'vivus', $nectar_get_template_directory_uri . '/js/third-party/vivus.min.js', 'jquery', '6.0.1', true );
		...
		wp_register_script( 'owl-carousel', $nectar_get_template_directory_uri . '/js/third-party/owl.carousel.min.js', 'jquery', '2.3.4', true );
		wp_register_script( 'leaflet', $nectar_get_template_directory_uri . '/js/third-party/leaflet.js', 'jquery', '1.3.1', true );
		wp_register_script( 'twentytwenty', $nectar_get_template_directory_uri . '/js/third-party/jquery.twentytwenty.js', 'jquery', '1.0', true );
		...
		wp_register_script( 'stickykit', $nectar_get_template_directory_uri . '/js/third-party/stickkit.js', 'jquery', '1.0', true );
		wp_register_script( 'pixi', $nectar_get_template_directory_uri . '/js/third-party/pixi.min.js', 'jquery', '4.5.1', true );
		wp_register_script( 'anime', $nectar_get_template_directory_uri . '/js/third-party/anime.js', 'jquery', '4.5.1', true );
		wp_register_script( 'nectar-waypoints', $nectar_get_template_directory_uri . '/js/third-party/waypoints.js', 'jquery', '4.0.1', true );
		
		// Page option conditional scripts.
		wp_register_script( 'nectar-single-product', $nectar_get_template_directory_uri . '/js/nectar-single-product.js', 'jquery', $nectar_theme_version, true );
		wp_register_script( 'nectar-fullpage', $nectar_get_template_directory_uri . '/js/elements/nectar-full-page-rows.js', 'jquery', $nectar_theme_version, true );
		wp_register_script( 'nectar-box-roll', $nectar_get_template_directory_uri . '/js/nectar-box-roll.js', array( 'jquery', 'touchswipe' ), $nectar_theme_version, true );
		wp_register_script( 'nectar-particles', $nectar_get_template_directory_uri . '/js/nectar-particles.js', 'jquery', $nectar_theme_version, true );
		
		// Register Salient element scripts.
		wp_register_script( 'nectar-leaflet-map', $nectar_get_template_directory_uri . '/js/elements/nectar-leaflet-map.js', 'jquery', $nectar_theme_version, true );
		wp_register_script( 'nectar-masonry-blog', $nectar_get_template_directory_uri . '/js/elements/nectar-blog.js', 'jquery', $nectar_theme_version, true );
		wp_register_script( 'nectar-liquid-bgs', $nectar_get_template_directory_uri . '/js/elements/nectar-liquid.js', 'jquery', $nectar_theme_version, true );
		wp_register_script( 'nectar-testimonial-sliders', $nectar_get_template_directory_uri . '/js/elements/nectar-testimonial-slider.js', 'jquery', $nectar_theme_version, true );
		...
		if( nectar_using_content( array('nectar_portfolio', 'vc_gallery type="image_grid"', 'type="image_grid"') ) || 
		...
		if( nectar_using_content(array('[recent_projects', '[carousel', 'carousel="true"', 'carousel="1"')) || is_page_template( 'template-home-1.php' ) ) {
			wp_enqueue_script( 'caroufredsel' );
		}


		if ( nectar_using_content( array('script="owl_carousel"')) ) {
			wp_enqueue_script( 'owl-carousel' );
		}
		
		// Row/Column BG animation deps.
		if ( nectar_using_content(array('bg_image_animation="displace-filter')) ) {
			wp_enqueue_script( 'pixi' );
			wp_enqueue_script( 'anime' );
			wp_enqueue_script( 'nectar-liquid-bgs' );
		}
		if ( nectar_using_content(array('animation="slight-twist"')) ) {
			wp_enqueue_script( 'anime' );
		}
		
		if ( nectar_using_content(array('[testimonial_slider')) ) {
...
function nectar_page_specific_js() {
	...
	// Infinite scroll.
	if ( nectar_using_content(array('pagination_type="infinite_scroll"')) ) {
		wp_enqueue_script( 'infinite-scroll' );
	}

	// Gallery slider scripts.
	if ( nectar_using_content(array('[nectar_blog')) ) {
			wp_enqueue_script( 'flexslider' );
	}

	// Sticky sidebar.
	if ( nectar_using_content(array('[nectar_blog')) && nectar_using_content(array('enable_ss="true"')) ) {
		wp_enqueue_script( 'stickykit' );
	}

	// Isotope.
	if ( nectar_using_content(array('[nectar_blog')) && nectar_using_content(array('layout="masonry')) ||
		nectar_using_content(array('[nectar_blog')) && nectar_using_content(array('layout="std-blog-')) && nectar_using_content(array('blog_standard_style="classic')) ) {
		wp_enqueue_script( 'isotope' );
		wp_enqueue_script( 'nectar-masonry-blog' );
	}
	...
	if ( ( $enable_ss == '1' && is_single() && $posttype === 'post' ) || nectar_using_content(array('[vc_widget_sidebar')) ) {
		  wp_enqueue_script( 'stickykit' );
	}

	// Nectar slider.
	if ( nectar_using_content(array('[nectar_slider')) || nectar_using_content(array('type="nectarslider_style"')) ) {
		wp_enqueue_script( 'nectar-slider' );
	}
	...
	if ( nectar_using_content($nectar_flickity_els) ) {
		wp_enqueue_script( 'flickity' );
	}
	...
	// svg icon animation
	if ( nectar_using_content(array('.svg')) ) {
		wp_enqueue_script( 'vivus' );
	}
