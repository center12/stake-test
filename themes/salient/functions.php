...
/**
 * StakeGlobal functions and definitions list.
 *
 * @package StakeGlobal
 * @since 0.0.1
 */
...
/**
 * Admin assets (on loan from Salient theme. Will I return them? Probs not...)
 */
...
/**
 * Third party. (from salient init commit)
 */
